...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `${this.capitalizeFirstLetter(this.props.category)}-LatestNews;`
  }
  async updateNews (){
  ...
  render() {
    return (
      <>
        <h2 className="text-center"style={{margin:'35px 0px'}}>Latest News - Top Headlines from {this.capitalizeFirstLetter(this.props.category)}</h2>
